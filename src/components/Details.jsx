  ...
  return (
    <>
      ...
      <div className="grid grid-cols-[1fr_380px] gap-20 w-[1440px] mx-auto my-20">
        <div className="flex w-full col-start-1 gap-10">
          <img
            src={item.img}
            className="w-[50%] h-[675px] object-contain bg-white shadow-md rounded-md"
            alt={item.title}
          />
          <img
            src={item.detail}
            className="w-[50%] object-contain bg-white shadow-md rounded-md"
            alt={item.title}
          />
        </div>
        <div className="flex flex-col col-start-2 h-full w-fit pt-12 bg-white shadow-md px-10 rounded-md">
